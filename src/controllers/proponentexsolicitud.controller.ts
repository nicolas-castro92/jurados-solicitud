...
export class ProponentexsolicitudController {
  ...
  @get('/proponentexsolicituds/count')
  @response(200, {
  ...
  @patch('/proponentexsolicituds/{id}')
  @response(204, {
